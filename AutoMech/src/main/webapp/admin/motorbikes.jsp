...
<html>
	<head>
		<title>Motorbikes - AutoMech Administrator</title>
			...
			<div id="content-wrapper" class="d-flex flex-column">
				<div id="content">
					...
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Motorbikes</h1>
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Motorbikes List</h6>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table table-bordered user" width="100%" cellspacing="0">
										<thead>
										...
										<tbody>
	                						...
	                						<tr>
												...
												<td><% out.print(owner); %></td>
												<td><% out.print(kilometer); %></td>
											</tr>
											<% } %>
										</tbody>
									</table>
