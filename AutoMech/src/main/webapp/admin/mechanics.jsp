								...
								<div class="table-responsive">
									<table class="table table-bordered" width="100%" cellspacing="0">
										...
										<tbody>
											...
											%>
											<tr>
												<td><% out.print(mechanic_code); %></td>
												<td><% out.print(name); %></td>
												<td><% out.print(specialization); %></td>
												<td class="text-center">
													<form action="mechanics-edit.jsp" class="user" method="post">
														<input type="hidden" value="<% out.print(mechanic_id); %>" name="mechanic">
