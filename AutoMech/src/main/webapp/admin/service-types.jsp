...
<html>
	<head>
		<title>Service Types - AutoMech Administrator</title>
			...
			<div id="content-wrapper" class="d-flex flex-column">
				<div id="content">
					...
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Service Types</h1>
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Service Types List</h6>
							</div>
							<div class="card-body">
								<form class="user">
									<div class="text-left">
	                			...
	                			<div class="table-responsive">
									<table class="table table-bordered" width="100%" cellspacing="0">
	                					...
	                					<tbody>
			                        		...
			                        		%>
											<tr>
												<td><% out.print(service_code); %></td>
												<td><% out.print(name); %></td>
												<td>RM<% out.print(price); %></td>
												<td class="text-center">
													<form action="service-types-edit.jsp" class="user" method="post" style="display: inline;">
														<input type="hidden" value="<% out.print(service_type_id); %>" name="service-type">
														<button class="btn btn-warning btn-user" type="submit">
															<i class="fa fa-file"></i>&nbsp;&nbsp;Manage
														</button>
													</form>
													<form action="deleteServiceType" class="user" method="post" style="display: inline;" onsubmit="return confirm('Do you want to delete this service type?');">
														<input type="hidden" value="<% out.print(service_type_id); %>" name="service-type">
