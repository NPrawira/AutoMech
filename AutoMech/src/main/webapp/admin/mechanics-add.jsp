...
<html>
	<head>
		<title>Add Mechanic - AutoMech Administrator</title>
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<div class="container col-md-5">
							<form action="createMechanic" class="user" method="post" onsubmit="return confirm('Add this new mechanic?');">
								<div class="card">
									<div class="card-body">
										<fieldset class="form-group">
											...
											<input type="text" class="form-control form-control-user" id="mechanic_code" name="mechanic_code" maxlength="5" value="M<%=n%>" style="background: white;" readonly="readonly">
											<label>Name</label>
											<input type="text" class="form-control form-control-user" id="name" name="name" maxlength="30" required="required">
										...
										<input class="btn btn-primary btn-user" type="submit" value="Add mechanic">
									</div>
								</div>
							</form>
						</div>
