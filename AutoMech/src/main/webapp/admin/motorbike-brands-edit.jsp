...
ResultSet rs = stmt.executeQuery("SELECT * FROM motorbike_brands WHERE motorbike_brand_id = '" + id + "'");
rs.next();
...
<html>
	<head>
		<title>Motorbike Brand: <% out.print(name); %> - AutoMech Administrator</title>
			...
			<div id="content-wrapper" class="d-flex flex-column">
				<div id="content">
					...
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Manage Motorbike Brand</h1>
	                	<div class="container col-md-5">
							<form action="editBrand" class="user" method="post" onsubmit="return confirm('Update this motorbike brand?');">
								<div class="card">
									<div class="card-body">
										<input type="hidden" id="brand_id" name="brand_id" value="<% out.print(motorbike_brand_id); %>">
										<fieldset class="form-group">
											<label>Name</label>
											<input type="text" class="form-control form-control-user" id="name" name="name" value="<% out.print(name); %>" maxlength="20" required="required">
										</fieldset>
