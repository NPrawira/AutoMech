...
<html>
	<head>
	    <title>Add Motorbike Brand - AutoMech Administrator</title>
			...
			<div id="content-wrapper" class="d-flex flex-column">
				<div id="content">
					...
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Add Motorbike Brand</h1>
						<div class="container col-md-5">
							<form action="createBrand" class="user" method="post" onsubmit="return confirm('Add this motorbike brand?');">
								<div class="card">
									<div class="card-body">
										<fieldset class="form-group">
											<label>Name</label>
											<input type="text" class="form-control form-control-user" id="name" name="name" required="required" maxlength="20">
										</fieldset>
										<input class="btn btn-primary btn-user" type="submit" value="Add brand">
									</div>
								</div>
							</form>
						</div>
