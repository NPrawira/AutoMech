							...
							<div class="card">
								<div class="card-body">
									<fieldset class="form-group">
										...
										<input type="text" class="form-control" id="service_code" name="service_code" value="ST<%=n%>" style="background: white;" readonly>
										<label>Name</label>
										<input type="text" class="form-control" id="name" name="name" maxlength="30" required>
										<label>Price (RM)</label>
										<input type="number" class="form-control" id="price" name="price" required>
									</fieldset>
									<input class="btn btn-primary" type="submit" value="Add service type">
								</div>
							</div>
						</form>
					</div>
