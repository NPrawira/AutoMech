...
ResultSet rs = null;
rs = stmt.executeQuery("SELECT * FROM mechanics WHERE mechanic_id = '"+id+"'");
rs.next();
							...
							<div class="card">
								<div class="card-body">
									...
									<fieldset class="form-group">
										...
										<input type="text" class="form-control" id="mechanic_code" name="mechanic_code" value="<%=rs.getString("mechanic_code")%>" style="background: white;" required="required" readonly="readonly">
										<label>Name</label>
										<input type="text" class="form-control" id="name" name="name" value="<%=rs.getString("name")%>" maxlength="30" required="required">
